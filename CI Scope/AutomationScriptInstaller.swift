...
struct AutomationScriptInstaller {
    ...
    func install(
        ...
        // brand-new project's very first PR fires workflow_job:queued the
        // moment it opens, and if the webhook doesn't exist yet that event has
        // nowhere to go — permanently stuck, unrecoverable (see NexusUnity,
        // 2026-07-04). Attaching first guarantees the webhook is live before
        // GitHub could possibly send anything.
