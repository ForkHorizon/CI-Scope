...
extension AutomationScriptInstaller {
    func validateRunnerAccessIfNeeded(mode: AutomationScriptInstallMode, project: CIProject) async throws {
        ...
        guard let data = output.data(using: .utf8),
            ...
            throw AutomationScriptError.invalidValue("Could not read repository permission for MacBook Runner.")
        }
