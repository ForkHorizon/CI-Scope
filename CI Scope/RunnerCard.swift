    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            LazyVGrid(columns: columns, spacing: 8) {
                RunnerMetric(title: "Agent", value: runner.launchctlState.capitalized, detail: localDetail, state: runner.localState)
                RunnerMetric(
                    title: "Control Plane", value: runner.remoteStatus.capitalized, detail: "VPS connected", state: runner.githubState)
                RunnerMetric(
